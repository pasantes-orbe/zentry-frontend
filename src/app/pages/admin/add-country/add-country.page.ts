...
export class AddCountryPage implements AfterViewInit, OnDestroy, OnInit { 
  @ViewChild(IonContent, { static: false }) content!: IonContent;
  @ViewChild('formSection', { read: ElementRef, static: false }) formSection!: ElementRef;

  private map: L.Map | null = null;
  public lat: number = -27.4512;
  public lng: number = -58.9867;
...
  public minPerimeterPoints: number = 3;
