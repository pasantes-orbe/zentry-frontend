...
  // ✅ MÉTODO CORREGIDO (Solución: Devuelve un Observable<...> simple)
...
    fd.append('roleRecurrent', String(payload.roleRecurrent));
    fd.append('access_days', String(payload.access_days));
